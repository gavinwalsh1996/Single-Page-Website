...
const PriceCard = ({ title, price, accounts, access }) => { //Receives title and price props from parent
    return (
        <div className="bg-slate-300 p-6 border-2 cursor-pointer hover:bg-white hover:scale-110 transition-all ease-in duration-300 ...">
            ...
            <ul className="pl-4 mb-4 list-none border-b-2">
             ...
             <button className="bg-red-600 text-white px-4 py-2 rounded-lghover:bg-indigo-600
