        ...
        <div className="grid sm:grid-cols-3">
            ...
            {gridContent.map((item) => (
                <div className="col-span-1 flex flex-col justify-center items-center p-10 ">
                    <span className='flex gap-4 text-lg font-medium dark:text-white sm:font-medium md:font-bold' style={{letterSpacing: '0.75px'}}>
                        <PlayArrowIcon sx={{color: '#1abc9c'}}/>{item.heading}
                    </span>
