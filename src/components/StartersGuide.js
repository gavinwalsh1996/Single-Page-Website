...
function StartersGuide() {
  ...
  return (
    ...
    <div className='p-10 bg-slate-100 dark:bg-slate-900 mt-32 mb-32'>
        ...
        <button className="hover:bg-indigo-800 text-white px-4 py-2 rounded-lg bg-indigo-600 transition-colors duration-300 ease-in-out w-80"><StarIcon/> START YOUR FREE TRIAL</button>
        <span className='dark:text-white'>- OR -</span>
        <button className="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-800 transition-colors duration-300 ease-in-out w-80"><PersonIcon/> SIGN UP FOR A SUBSCRIPTION</button>
        </div>
    </div>
